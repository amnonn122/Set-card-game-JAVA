...
public class UserInterfaceDecorator implements UserInterface {
    ...
    public UserInterfaceDecorator(Logger logger, Util util, UserInterface ui) {
        ...
        if (ui == null)
            System.out.println("running without a user interface. Check logs.");
    }
